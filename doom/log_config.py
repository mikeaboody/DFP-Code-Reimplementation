...
log_agent_param['testing_num_episodes'] = 1
log_agent_param['training_num_steps'] = 200
# this is number of time the function is called
log_agent_param['test_eval_freq'] = 30
...
# log the agent param
log_network_param = {}
log_network_param['log_path'] = 'log/network/network.log'
log_network_param['to_log'] = True
